...
- For exact context, prefer `context_snapshot` files over dashboard previews. Large raw context can be summarized or omitted from replay but retained on disk.
