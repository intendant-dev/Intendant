...
function Show-CompletionSummary {
    ...
    Warn "   - LAN enrollment: native 'intendant access' enrollment is Unix-validated; use scripts\setup-lan.bat with WSL/a Linux guest, explicit --tls-cert/--tls-key, or your own reverse proxy."
