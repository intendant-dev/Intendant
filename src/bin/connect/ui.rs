...
pub(crate) const LANDING_ADVISOR_HTML: &str = r##"<div class="advisor" id="advisor">
        ...
        <div class="advbody">
          ...
          <div class="advq" data-q="fuel">
            ...
            <button data-v="sub">Subscriptions (Codex, Claude Code, Kimi Code, Pi)</button>
  ...
  <div class="wrap">
    ...
    <section class="hero">
      ...
      <p>
        ...
        loop, supervises Codex, Claude Code, Kimi Code, and Pi as managed backends,
        and is portable across OpenAI, Anthropic, and Gemini. The agent's machine
