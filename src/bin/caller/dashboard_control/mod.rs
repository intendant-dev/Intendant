...
mod tests {
    ...
    fn tunnel_method_partition_is_pinned() {
        ...
        let frozen: &[(&str, Source, Option<Op>)] = &[
            ...
            ("api_kimi_auth_start", Row, Some(Op::CredentialsManage)),
            ("api_kimi_auth_status", Row, Some(Op::CredentialsManage)),
            ("api_kimi_auth_cancel", Row, Some(Op::CredentialsManage)),
            (
            ...
            ("api_agenda_item", Row, Some(Op::AgendaRead)),
            ("api_agenda_ops", Row, Some(Op::AgendaRead)),
            ("api_agenda_occurrences", Row, Some(Op::AgendaRead)),
            ("api_agenda_op", Row, Some(Op::AgendaWrite)),
            ("api_agenda_definitions", Row, Some(Op::AgendaRead)),
            ("api_agenda_definition_add", Row, Some(Op::Settings)),
            ("api_agenda_definition_remove", Row, Some(Op::Settings)),
            ("api_agenda_sealed", Row, Some(Op::AgendaRead)),
            ("api_agenda_stamp", Row, Some(Op::AgendaWrite)),
            ("api_agenda_ref_drift", Row, Some(Op::AgendaRead)),
            ("api_agenda_ref_content", Row, Some(Op::AgendaRead)),
            ("api_agenda_pr_state", Row, Some(Op::AgendaRead)),
            ("api_agenda_reminder_policy", Row, Some(Op::Settings)),
            ("api_daemon_handover", Row, Some(Op::StatsRead)),
            ("api_plugins_list", Row, Some(Op::StatsRead)),
            ("api_plugin_set_enabled", Row, Some(Op::Settings)),
            ("api_skills_list", Row, Some(Op::StatsRead)),
            ("api_skill_set_enabled", Row, Some(Op::Settings)),
            ("api_skill_add", Row, Some(Op::Settings)),
            ("api_skill_remove", Row, Some(Op::Settings)),
            ...
            ("api_memory_judge", Row, Some(Op::MemoryWrite)),
