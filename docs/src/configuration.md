...
| `context_recovery` | string | `off` | `off` for vanilla/forked Codex; `patched` enables Intendant rewind/backout tools, disables Codex auto-compaction, and requires the patched Codex app-server protocol |
