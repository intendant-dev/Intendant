...
session grant and verifies that the browser-visible grant, browser challenge
nonce, and signed expiry are bound into the daemon-signed WebRTC session
statement. It exists to prove the browser-public-origin → rendezvous →
