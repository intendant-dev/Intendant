...
> Native, Codex, and Kimi work out of the box; Anthropic's
...
- The user's *subscription* identities (ChatGPT plan auth for Intendant Native
  or Codex,
...
agents (Codex, Claude Code, Kimi Code). Each entry carries a kind, a label, provider metadata, and
...
**The OAuth split (Intendant Native, Codex, Claude Code, Kimi Code).**
...
- **Access-token lease (the browser UX default):** the browser keeps the **refresh
  ...
  **Intendant Native, Codex, and Kimi fuel this way out of the box**; Anthropic's
