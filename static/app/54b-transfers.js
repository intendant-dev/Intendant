// ── Files transfers ──
// The Files tab transfer engine: resumable downloads/uploads over the
// transfer-job API, the IndexedDB part/blob store behind refresh-safe
// resume, the queue pump, staged uploads, and transfer history. Status
// writes flow through 53-transfer-fsm.js; the queue state lives in the
// early client-state block (31-init-identity-fleet.js).
