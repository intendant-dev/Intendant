...
function processCommands(cmds) {
  ...
  try {
    for (const c of cmds) {
      ...
      case 'show_user_question': showUserQuestion(c.id, c.questions, c.session_id, c.expires_at_ms, c.held); break;
      ...
      case 'session_pr_published': applySessionPrPublished(c); break;
